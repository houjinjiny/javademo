...
import com.game.pojo.BlueInscription;
import com.game.pojo.GreenInscription;
import com.game.pojo.OrangeInscription;
...
public class RuneUser {
    ...
    RuneUser(String account, String passwd)
    {
...
//      String insCategory[]={"攻击","生命","防御","功能","吸血","攻速","暴击","穿透"};
        while(true)   //每次大循环选择任意数量的一种铭文，选够30才能离开循环
        {
            ...
            while (true)
            {
                System.out.println("请先按序号选择铭文颜色:");
                color = sc.nextInt();
